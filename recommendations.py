...
def graphical_visualization():
	os.system('python3 recommendation_graph.py')
...
details_button = Button(root, text = 'MORE DETAILS', command = more_info, font=('',12), bd=-2, bg='grey',fg='white')
details_button.place(x=200,y=300)
